...
from STrx_only import CNN_Strx
...
class Learner:
    def __init__(self):
        ...
        self.optimizer = torch.optim.Adam(self.model.parameters(), lr=self.args.learning_rate, weight_decay=5e-5)
    ...
    def lr_func(self, step):
        ...
        if epoch < self.args.warmup_epochs:
            ...
            return 0.5 + 0.5 * math.cos(
                (epoch - self.args.warmup_epochs) / (self.args.epochs - self.args.warmup_epochs) * math.pi)
    ...
    def parse_command_line(self):
        ...
        parser.add_argument("--dataset", choices=["ssv2", "kinetics", "hmdb", "ucf", "diving"], default="ssv2",
                            help="Dataset to use.")
        ...
        parser.add_argument("--training_iterations", "-i", type=int, default=200020,
        ...
        parser.add_argument('--test_iters', nargs='+', type=int,
                            ...
                            default=[2000, 4000, 6000, 8000, 10000, 12000, 14000, 16000, 18000, 20000, 22000, 24000,
                                     ...
                                     50000, 52000, 54000,
                                     56000, 58000, 60000, 62000, 64000, 66000, 68000, 70000, 72000, 74000, 76000, 78000,
                                     80000, 82000, 84000,
                                     86000, 88000, 90000, 92000, 94000, 96000, 98000, 100000, 102000, 104000, 106000,
                                     108000, 110000, 112000, 114000, 116000, 118000, 120000, 122000, 124000,
                                     126000, 128000, 130000, 132000, 134000, 136000, 138000, 140000, 142000, 144000,
                                     146000, 148000, 150000, 152000, 154000,
